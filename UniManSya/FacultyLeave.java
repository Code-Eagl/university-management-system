...
public class FacultyLeave  extends JFrame implements ActionListener{
	...
	public FacultyLeave() {
		...
		JLabel heading= new JLabel("Leave Application for Faulty");
		...
		JLabel lfild= new JLabel("Reason of leave");
...
//		add(pane);
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==add) {
			...
			String query="insert into facultyleave values ('"+eid+"','"+date+"','"+duration+"','"+readon+"')";
			try {
				Conn c=new Conn();
